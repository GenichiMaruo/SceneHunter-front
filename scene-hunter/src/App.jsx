    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-center">
      {screen === 'main' ? (
        <>
          ...
          <button className="my-[5vw] px-[10vw] py-[2vw] bg-[#003B5C] text-[5vw] text-white rounded " onClick={handleGoBack}>
            {language === 'jp' ? '戻る' : 'Back'}
          </button>
          </Modal>
          ...
          >
            ...
            />
            <button className="my-[2vw] px-[10vw] py-[2vw] bg-[#003B5C] text-[5vw] text-white rounded" onClick={handleEnterRoom}>
              {language === 'jp' ? '参加' : 'Join'}
            </button>
            <button className="my-[2vw] px-[10vw] py-[2vw] bg-[#003B5C] text-[5vw] text-white rounded" onClick={handleGoBack}>
              {language === 'jp' ? '戻る' : 'Back'}
            </button>
          </Modal>
        </>
